...
export const SPRING_GLIDE = { stiffness: 380, damping: 32, mass: 0.8 };
export const SPRING_PRESS = { stiffness: 450, damping: 35, mass: 0.6 };
      ...
      {active && surfaceHost && surfaceWidth > SURFACE_INSET * 2
        ? createPortal(
            <svg
              ...
              className={cn(
                "pointer-events-none absolute inset-x-0 top-0 h-[96px] w-full text-[#141414]",
                dragging ? "z-20" : "z-0",
                surfaceClassName,
              )}
            >
...
export function MorphingTabs({
  ...
  const [tabGap, setTabGap] = useState(10);
  ...
  return (
    <div
      ref={rootRef}
      className={cn(
        "relative isolate min-w-0 overflow-hidden rounded-[2rem] bg-[#0c0c0c] border border-[#1f1f1f] text-white shadow-2xl",
        classNames?.root,
        className,
      )}
    >
      <div className="relative h-20">
        <div
          ...
          className={cn(
            "relative z-30 flex h-full gap-3 md:gap-4 overflow-x-auto no-scrollbar",
            classNames?.rail,
          )}
        >
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    className={cn(
                      "group relative z-10 flex h-full w-full min-w-0 items-center gap-2 overflow-hidden rounded-t-[1.25rem] px-3 text-left outline-none transition-colors",
                      isActive
                  ...
                  >
                    <span
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bottom-0 rounded-t-[1rem] border-x-2 border-t-2 border-primary/40"
                          : "bottom-2 rounded-[1rem] border-2 border-white/40",
                      )}
                    />
                    {item.icon ? (
                      <span
                    ...
                    <span
                      className={cn(
                        "min-w-0 truncate whitespace-nowrap text-sm font-medium leading-none tracking-tight font-barlow",
                        classNames?.label,
                      )}
                    >
                      {item.label}
                  ...
                  {onClose ? (
                    <button
                      ...
                      className={cn(
                        "absolute right-2 top-1/2 z-20 grid size-6 -translate-y-1/2 place-items-center rounded-full text-gray-400 transition-colors hover:bg-white/[0.08] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current",
                        !isActive &&
                          "top-[calc(50%-4px)] text-white/40 hover:bg-white/[0.08] hover:text-white/80",
                        classNames?.close,
                      )}
                    >
      ...
      <div
        ...
        className={cn(
          "relative z-20 mx-3 mb-3 sm:mx-4 sm:mb-4 min-h-64 overflow-hidden rounded-[1.5rem] bg-[#141414] border border-white/[0.06] text-white p-6 sm:p-8",
          classNames?.content,
        )}
      >
