          ...
          <div className="border-t border-white/10 pt-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              {trackRecord.map((stat, i) => (
                <div
                  key={i}
                  className="text-center group py-5 px-4 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:border-primary/30 hover:bg-white/[0.04] transition-all duration-300"
                >
                  <p className="text-primary font-barlow text-3xl md:text-4xl font-bold mb-1.5 group-hover:scale-105 transition-transform duration-300 inline-block">
                    {stat.title}
                  </p>
                  <p className="text-gray-400 text-xs md:text-sm font-barlow tracking-wide">
                    {stat.subtitle}
                  </p>
                </div>
              ))}
